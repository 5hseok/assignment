...
SECRET_KEY = 'django-insecure-y61fe*v03q-+lw#h9n*l7ksc+kh80#h*y85h56-lwyu@7^&#an'
...
INSTALLED_APPS = [
    'django.contrib.admin',      # 프로젝트 생성시 자동 포함되지만 사용하지 않음
    'django.contrib.auth',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'opengallery.context_processors.user_extras',
            ],
        },
    },
]
